...
Afterwards, run `node generatePackagedPlayer.js "Adventure Directory Name" "starting_scene"` which will generate an adventure HTML file in `PackagedPlayers` with the name of your adventure directory.
